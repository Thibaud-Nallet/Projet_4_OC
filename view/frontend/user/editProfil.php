...
<section class="col-lg-6 offset-lg-6" id="connect">
    ...
    <form action="#" method="post" enctype="multipart/form-data">
        ...
        <div class="col-lg-8 offset-lg-2">
            ...
            <input type="email" class="formInput" id="input_NewMail" name="input_NewMail" value="<?= $_SESSION['email']; ?>">
        </div>
        <div class="col-lg-8 offset-lg-2">
            <label class="labelForm" for="input_NewPassword"> Changez de mot de passe </label>
            <input type="password" class="formInput" id="input_NewPassword" name="input_NewPassword">
        </div>
        <div class="col-lg-8 offset-lg-2">
