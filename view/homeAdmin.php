            ...
            <div class="col-md-4">
                <div class="col-lg-8 offset-lg-2" id="blockAdmin">
                    <p> Liste d'articles <br />
                        <hr>
                        <a href="readPost.php"><i class="fas fa-list-ul fa-2x"></i> </a> </p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="col-lg-8 offset-lg-2" id="blockAdmin">
                    <p> Rédiger un article <br />
                        <hr>
                        <a href="writePost.php"><i class="fas fa-pen-nib fa-2x"></i> </a> </p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="col-lg-8 offset-lg-2" id="blockAdmin">
                    <p> Gérer les commentaires <br />
                        <hr>
                        <a href="readComments.php"><i class="far fa-comments fa-2x"></i> </a> </p>
                </div>
            </div>
        </div>
    </section>
