        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-3 headerButton">
                    ...
                    <a href="blog.php" id="headerButtonRead" class="btn" role="button"> Lire le roman </a>
                </div>
            </div>
        </div>
    </header>
    ...
    <section id="presentation">
        <div class="container" id="bio">
            <div class="row">
                ...
                <div class="col-md-4">
                    <figure id="portrait">
                        <img src="/Projet_4_OC/public/images/auteur.jpg" alt="photo de Jean Forteroche">
                    </figure>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <figure class="liseuse">
                        <img src="/Projet_4_OC/public/images/liseuse.jpg" alt="personne lisant sur une liseuse">
                    </figure>
                </div>
                <div class="col-md-6">
                    <p class="text-justify biographie">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <figure class="interaction">
                        <img src="/Projet_4_OC/public/images/interaction.jpg" alt="Deux personnes sur une table regardant leur smartphone">
                    </figure>
                </div>
            </div>
        </div>
