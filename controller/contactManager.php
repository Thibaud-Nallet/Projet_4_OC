...
$array = array("firstname" => "", "name" => "", "email" => "", "phone" => "", "object" => "", "message" => "", "firstnameError" => "", "nameError" => "", "emailError" => "", "phoneError" => "", "messageError" => "", "isSuccess" => false);
$emailTo = "thibaud.nallet@gmail.com";
